  ...
  function renderDivDetail() {
    ...
    return (
      <>
        ...
        {/* sheet — /div 는 MOBILE_NO_NAV_PATHS (BottomNav 없음) → bottom:0 + max-h safe-area only */}
        <div
          className="fixed left-0 right-0 bottom-0 z-[99] bg-surface-raised rounded-t-2xl p-[16px_16px_36px] border-t border-border-default overflow-y-auto overflow-x-hidden max-h-[calc(100dvh-var(--sat,0px)-var(--sab,0px))]"
