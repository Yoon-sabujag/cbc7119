...
export const DIV_POINTS = [
  ...
  { floor: -1, pos: 2, id: '-1-2', floorLabel: 'B1층',  loc: '지) B1층 식당 뒤' },
  { floor: -1, pos: 3, id: '-1-3', floorLabel: 'B1층',  loc: '지) B1층 화장실' },
  ...
  { floor: -4, pos: 1, id: '-4-1', floorLabel: 'B4층',  loc: '지) B4층 기계실' },
  { floor: -4, pos: 2, id: '-4-2', floorLabel: 'B4층',  loc: '지) B4층 팬룸'   },
