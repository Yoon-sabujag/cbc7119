...
Last activity: 2026-05-29 - **Tier 3 진행** Phase B Wave 16b (260529-sqk): 중형 batch 분할 atomic (16b-1 InstallPrompt 41→2 + 16b-2 ExcelPreview 18→7 + DesktopSidebar 17→0) = 76→9 (-88%). 다음: Wave 16c (XS batch 60) 또는 cherry-pick
